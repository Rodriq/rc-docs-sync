...
Although we recommend using [Docker and Docker Compose](../../installing-and-updating/rapid-deployment-methods/docker-and-docker-compose), you may want to know when best to consider any of the other deployment methods.
